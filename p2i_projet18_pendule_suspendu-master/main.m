...
a = 0.1;%amplitude de l'exitation d'entree 
...
choix = 1; %variable choix prennant des valeurs de 1 à 3 pour choisir d'afficher la solution non-linéaire et la solution linéaire ou une comparaison des deux
